                    ...
                    <div class="login-form-container">
                        <div class="login-form">
                            ...
                            <form method="POST" action="{{ route('password.update') }}">
                                ...
                                <input id="email" type="email" name="email" placeholder="Email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                                ...
                                <div class="button-box">
                                    <button type="submit" class="default-btn floatright">{{__('home.resetpw')}}</button>
                                </div>
                            </form>
